    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a href="/categories" class="nav-link">Race Event</a>
                </li>
                <li class="nav-item">
            ...
            @auth
                ...
                <ul class="navbar-nav d-none d-lg-flex">
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown">Hai,
                            {{ Auth::user()->name }} </a>
                ...
                <ul class="navbar-nav d-block d-lg-none">
                    <li class="nav-item">
                        <a href="{{ route('dashboard') }}" class="nav-link d-inline-block"> Hi,
                            {{ Auth::user()->name }} </a>
                    </li>
                    <li class="nav-item">
