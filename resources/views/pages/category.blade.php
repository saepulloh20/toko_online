        ...
        <section class="store-trend-categories">
            <div class="container">
                ...
                <div class="row">
                    ...
                    @empty
                        <div class="col-12 text-center py-5" data-aos="fade-up" data-aos-delay="100">Categories Not Found
                        </div>
                    @endforelse
                </div>
            </div>
                    ...
                    @forelse ($products as $product)
                        <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up"
                            ...
                            ">
                                ...
                                <div class="products-price">{{ $product->name }}</div>
                                <div class="products-text">{{ $product->category->name }}</div>
                            </a>
                        </div>
                    @empty
